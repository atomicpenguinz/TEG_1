...
Algo a se notar é que cada variável é inicializada com o valor do extremo oposto
do que deve ser, a fim de garantir o comportamento correto das comparações.
A variável \textit{maior} começa com valor 0, o menor possível para
\textit{unsigned integers}. Já a variável \textit{menor} inicia com o máximo valor possível
para um \textit{uint}, dado pela biblioteca limitsh como \textit{UINT\_MAX}.
...
Inicialmente, a ideia foi de fazer a contagem através de uma.
